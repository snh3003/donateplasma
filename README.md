...
3) A more trustable data source through a trustless system
  Yes, we are talking about integrating the ####Ethereum blockchain network. Ethereum is popular for its immutable, decentralized yet transparent environment. Along with the power of Matic's Plasma chain system, we can build a more effective and affordable database system.
