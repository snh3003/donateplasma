        ...
        <div className={styles.parent}>
            ...
            <Jumbotron className={styles.main2}>
                ...
                <div className={styles.rightChild2}>
                    ...
                    <br />
                    <p>
                    Using our dapp people can volunteer to donate plasma and those who need blood plasma can now choose volunteer people based on their location and ask them for their voluntary help. This will help in reducing the number of COVID-19 cases and ultimately lower the spreading exponentially. We have used Matic Network’s Mumbai test network and have used Portis wallet to allow people to register and donate blood plasma using their mobiles directly due to metamask restrictions for mobile. 
                    </p>
                </div>
